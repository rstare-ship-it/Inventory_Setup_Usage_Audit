WITH
tenant_param AS (SELECT 498902358 AS tenant_id),
tenant_info AS (
...
SELECT 'usage_checks' AS source,
    TO_VARCHAR(uc.v1), TO_VARCHAR(uc.v2), TO_VARCHAR(uc.v3), TO_VARCHAR(uc.v4), TO_VARCHAR(uc.v5), TO_VARCHAR(uc.v6), TO_VARCHAR(uc.v7),
    CAST(NULL AS VARCHAR) AS v8, CAST(NULL AS VARCHAR) AS v9, CAST(NULL AS VARCHAR) AS v10,
    CAST(NULL AS VARCHAR) AS v11, CAST(NULL AS VARCHAR) AS v12, CAST(NULL AS VARCHAR) AS v13, CAST(NULL AS VARCHAR) AS v14, CAST(NULL AS VARCHAR) AS v15, CAST(NULL AS VARCHAR) AS v16
